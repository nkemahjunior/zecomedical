                ...
                <form className=" space-y-[2rem] xl:space-y-12" onSubmit={filterData} >
                    ...
                    <div className="w-full flex justify-center">
                        <button className={` text-white text-center w-[30%] 2xl:w-[20%] h-[3.8rem] md:h-[4.6rem] rounded-lg shadow-lg
                                        ...
                                        xl:hover:scale-95 ${disableRow ? 'pointer-events-none cursor-not-allowed bg-[#4d5d62]' : 'bg-[#00171F]'}`}
                            >Apply&nbsp;Filter
                        </button>
                    </div>
                        ...
                        <tbody >

                            {
                                filteredData?.map((el,i) => (
                                    ...
                                    disableRow ? <AppointmentRequestTableRow data={el}  key={i} current={i} setDisable={setDisableRow} disable={true}/> : 
                                    <AppointmentRequestTableRow data={el}  key={i} current={i} setDisable={setDisableRow} disable={false} />
