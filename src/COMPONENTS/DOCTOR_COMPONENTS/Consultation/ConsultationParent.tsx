...
export default function ConsultationParent({patientID, patientName}:{patientID:string, patientName:string}) {
    return (
        <div className={`grid grid-cols-1 xl:grid-cols-[60fr,40fr] ${textStylesBody}`}>
            ...
            <div className="border-0 border-green-800 border-solid  row-start-2 xl:row-start-1">
             ...
             <StartConsultation patientID={patientID} patientName={patientName}/>
            </div>
