...
export default function StartConsultation({patientID, patientName}:{patientID:string, patientName:string}) {
    ...
    return (
        ...
        " >
            ...
            >
                ...
                <SendToLab patientID={patientID} patientName={patientName}/>
