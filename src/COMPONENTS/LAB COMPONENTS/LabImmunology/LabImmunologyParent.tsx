...
import { useGetLabImmunologyRequests } from "@/DATA_FETCHING/LAB/hooks/useGetLabRequests";
...
import LabImmunologyTableRow from "./LabImmunologyTableRow";


 
 
export default function LabImmunologyParent() {
    ...
    const infiniteQuery = useGetLabImmunologyRequests(searchValue)
    ...
    return (
        ...
        >
            ...
            <div className="w-full flex justify-center">
                <h1 className={`${textStylesH3} text-black font-medium `}>Immunology Laboratory</h1>
            </div>
                        ...
                        <tbody >

                            {
                                infiniteQuery.data?.pages.map((el) => (
                                    el?.content?.map( (req) => (
                                        <LabImmunologyTableRow data={req} key={req.id}/>
                                    ) )
                                ))
                            }
