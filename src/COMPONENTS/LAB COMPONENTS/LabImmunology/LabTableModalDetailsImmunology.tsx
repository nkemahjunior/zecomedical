...
import { usePostLabImmunologyTestResults } from "@/DATA_FETCHING/LAB/hooks/usePostLabTestResults"
...
export default function LabTableModalDetailsImmunology({el}:{el:labRequestType}) {
    ...
    const mutation = usePostLabImmunologyTestResults()
