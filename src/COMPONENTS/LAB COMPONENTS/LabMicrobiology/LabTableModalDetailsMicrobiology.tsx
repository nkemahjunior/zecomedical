...
import { usePostLabMicroiologyTestResults } from "@/DATA_FETCHING/LAB/hooks/usePostLabTestResults";
...
export default function LabTableModalDetailsMicrobiology({el}:{el:labRequestType}) {
    ...
    const mutation = usePostLabMicroiologyTestResults()
