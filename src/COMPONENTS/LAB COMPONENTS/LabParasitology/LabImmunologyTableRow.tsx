...
import LabTableModalDetailsParasitology from "./LabTableModalDetailsParasitology"
import { extractDate } from "@/helpers/extractDate"



export default function LabParasitologyTableRow({data}:{data:labRequestType}) {

    const {setOpen , setContent} = useContext(LabModalContext) as LabContextTypes

    function openModal(){
        setOpen(true)
        setContent(<LabTableModalDetailsParasitology el={data}/>)
    }
