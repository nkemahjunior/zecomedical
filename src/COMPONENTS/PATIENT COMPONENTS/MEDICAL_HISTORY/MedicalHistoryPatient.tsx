...
export default function MedicalHistoryPatient() {
    ...
    return (
        <div className={`  border-0 border-solid border-red-700 ${textStylesBody} text-black  w-full
        ...
        `}>
          ...
          <div className="flex  justify-between items-center mb-2 md:mb-6">
                <h1 className={`${textStylesH3} text-black `}> Your Medical History</h1>
          ...
          <div className=" space-y-8 divide-y-2 divide-stone-300 divide-solid">
            ...
            {
              query.data?.map((el,i) => <MedicalHistoryChildPatient data={el} key={i}/> )
