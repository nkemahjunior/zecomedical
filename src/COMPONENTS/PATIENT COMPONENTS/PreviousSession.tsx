...
export default function PreviousSession() {
    ...
    return (
      <>
        <div>
          <h3 className={`mt-6 lg:mt-12 ${textStylesH3} text-[#00171F]`}>
            Previous Session
          </h3>

          {medHistory && (
            <div
              className="p-[1.2rem] py-[1.6rem] sm:p-[3rem] md:px-[4rem] md:py-[6rem] lg:px-[2rem] lg:py-[6rem] xl:px-[6rem] xl:py-[7rem]  mt-8 lg:mt-12 
            ...
            >
              ...
              >
                <Image
                  className="block"
                  src={
                    medHistory?.doctorID.uuid.profilePhotoUrl ||
                    "/defaultProfile.jpg"
                  }
              ...
              <div className=" ">
                <div className=" space-y-[0.2rem] lg:space-y-[0.7rem] xl:space-y-[1.4rem]">
                  ...
                  <p className={`${textStylesBody} text-white`}>
                    {" "}
                    {medHistory?.diagnosisNotes &&
                    medHistory.diagnosisNotes.length > 21
                      ? `${medHistory.diagnosisNotes.slice(0, 21)}...`
                      : `${medHistory?.diagnosisNotes}`}
                  </p>
                  ...
                  <p className={`${textStylesBody} text-white capitalize`}>
                    ...
                    medHistory?.medicinePrescribed.length > 21
                      ? `${medHistory?.medicinePrescribed.slice(0, 18)}...`
                      : medHistory?.medicinePrescribed}
                  </p>
                </div>
          ...
          {!medHistory && (
            ...
            >
              <div className="flex flex-col items-center justify-center">
                <p className="text-4xl">No session with a doctor yet! 😊 </p>
